...
verifyEqual(testCase, unique(csv.s2PathAuditMinCpMass_J_kgK), ...
    analysis.s2.pathAudit.minCpMass_J_kgK, "AbsTol", 1e-12);
verifyEqual(testCase, unique(csv.s2PathAuditMinCvMass_J_kgK), ...
    analysis.s2.pathAudit.minCvMass_J_kgK, "AbsTol", 1e-12);
verifyEqual(testCase, unique(csv.s2PathAuditMinGamma), ...
    analysis.s2.pathAudit.minGamma, "AbsTol", 1e-12);
verifyEqual(testCase, unique(csv.s2PathAuditMaxGamma), ...
    analysis.s2.pathAudit.maxGamma, "AbsTol", 1e-12);
verifyEqual(testCase, unique(csv.s2PathAuditMinPhi), ...
    analysis.s2.pathAudit.minPhi, "AbsTol", 1e-12);
verifyEqual(testCase, unique(csv.s2PathAuditMaxPhi), ...
    analysis.s2.pathAudit.maxPhi, "AbsTol", 1e-12);
