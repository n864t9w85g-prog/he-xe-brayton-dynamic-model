...
resolvedSourcePath = string(get_param(sourceModel, "FileName"));
if resolvedSourcePath ~= string(sourcePath)
    error("steady53:SourceModelIdentityMismatch", ...
        "Loaded source model resolved to '%s', expected durable path '%s'.", ...
