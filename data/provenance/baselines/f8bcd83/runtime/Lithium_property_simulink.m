...
% Thesis Table 5.2 lithium-loop closure calibration (2026-08-27, user-approved):
% the thesis set {reactor power 2664 kW, outlet 1600 K, inlet 1443.27 K,
% mdot 4.572 kg/s} closes only for cp_Li ~= 3717.7 J/(kg K); the ORNL fit
% gives 4136.2 at the loop mean temperature. Factor tuned by closed-loop bisection to Table 5.2 reactor power: 0.9615.
% Classification: calibration to thesis closure (not an ORNL value).
cp_mass = cp_mass * 0.9615;
